...
def make_log_tools(sandbox: str):
    """
    Build write_log/read_pending/add_pending/complete_pending bound to a
    single sandbox root, closed over here rather than accepted as a
    model-supplied argument - see files.py's make_file_tools() docstring
    for why.
    """
    ...
    def complete_pending(item_number: int) -> str:
        """
    ...
    return write_log, read_pending, add_pending, complete_pending
